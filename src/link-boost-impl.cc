...
LinkBoost::LinkBoost(Observer *owner, Board *board) : 
	Ability{"Link Boost", "Input: <Link> | Desc: Choose to boost one of your links. When boosted, the link moves 2 steps at every turn, with the ability to jump over obstacles", owner, board} {}
